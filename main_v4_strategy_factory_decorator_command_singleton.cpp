...
public:
    ...
    QMenu* createMenu(QWidget* parent) override {
        ...
        addCommandAction(menu, QString::fromLocal8Bit("剪切"), std::make_shared<NullCommand>());
        addCommandAction(menu, QString::fromLocal8Bit("粘贴"), std::make_shared<NullCommand>());
        return menu;
    }
...
public:
    QMenu* createMenu(QWidget* parent) override {
        ...
        addCommandAction(menu, QString::fromLocal8Bit("编辑文本"), std::make_shared<NullCommand>());
        addCommandAction(menu, QString::fromLocal8Bit("改变字体"), std::make_shared<NullCommand>());
        return menu;
    }
};
...
public:
    QMenu* createMenu(QWidget* parent) override {
        QMenu* menu = new QMenu(parent);
        addCommandAction(menu, QString::fromLocal8Bit("添加幻灯片"), std::make_shared<NullCommand>());
        addCommandAction(menu, QString::fromLocal8Bit("版式布局"), std::make_shared<NullCommand>());
        return menu;
    }
};
...
public:
    QMenu* createMenu(QWidget* parent) override {
        QMenu* menu = new QMenu(parent);
        addCommandAction(menu, QString::fromLocal8Bit("无公共操作，仅特殊操作"), std::make_shared<NullCommand>());
        return menu;
    }
};
...
public:
    QMenu* createMenu(QWidget* parent) override {
        QMenu* menu = new QMenu(parent);
        addCommandAction(menu, QString::fromLocal8Bit("改变颜色"), std::make_shared<NullCommand>());
        addCommandAction(menu, QString::fromLocal8Bit("旋转"), std::make_shared<NullCommand>());
        return menu;
    }
};
